  ...
  return (
    <MessageShortcuts copyText={image ? '' : content} placement="left">
      <div
        ...
        // }
        className={
          "flex-shrink-0 leading-6 mb-2 ml-8 self-end pl-4 pr-3 py-2 bg-white selection:bg-yellow whitespace-pre-line dark:bg-[#1A1A1A] rounded-tl-md rounded-bl-md rounded-tr-md relative flex flex-col "
        }
      >
