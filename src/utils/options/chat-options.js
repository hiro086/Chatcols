...
function getDefaultChatOptions() {
  return [
    ...
    optionOf("Top P", "top_p", "chat.options.top_p_desc", 0.1, 1, 0.7),
    // optionOf(
    //   'Top K',
    //   'top_k',
    ...
    optionOf(
      "chat.options.image_width",
      "image_width",
      "chat.options.image_width_desc",
      448,
      5600,
      896,
      true,
...
const _allModelChatOptions = getJsonDataFromLocalStorage(
  LOCAL_STORAGE_KEY.CHAT_MODEL_OPTIONS,
  {}
);
